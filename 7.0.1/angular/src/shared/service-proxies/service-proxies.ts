...
@Injectable()
export class DelegationServiceProxy {
    getRoles() {
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<DelegationDto> {
        let url_ = this.baseUrl + "/api/services/app/Delegation/Get?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<DelegationDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<DelegationDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<DelegationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DelegationDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<DelegationDto>(null as any);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<DelegationDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Delegation/GetAll?";
        if (sorting === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<DelegationDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<DelegationDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<DelegationDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DelegationDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<DelegationDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    create(body: DelegationDto | undefined): Observable<DelegationDto> {
        let url_ = this.baseUrl + "/api/services/app/Delegation/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<DelegationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: DelegationDto | undefined): Observable<DelegationDto> {
        let url_ = this.baseUrl + "/api/services/app/Delegation/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<DelegationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    delete(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Delegation/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class PageServiceProxy {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PageDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PageDto>;
        }));
    }
    ...
    protected processGet(response: HttpResponseBase): Observable<PageDto> {
        ...
        return _observableOf<PageDto>(null as any);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<PageDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PageDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PageDtoPagedResultDto>;
        }));
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<PageDtoPagedResultDto> {
        ...
        return _observableOf<PageDtoPagedResultDto>(null as any);
    }
...
export class Delegation implements IDelegation {
    ...
    libelleFR: string | undefined;
    code: number;
    libelleAR: string | undefined;
    observation: string | undefined;
    libelle: string | undefined;
    page: Page;
    pageId: string;

    constructor(data?: IDelegation) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.libelleFR = _data["libelleFR"];
            this.code = _data["code"];
            this.libelleAR = _data["libelleAR"];
    ...
    static fromJS(data: any): Delegation {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data?: any) {
        ...
        data["libelleFR"] = this.libelleFR;
        data["code"] = this.code;
        data["libelleAR"] = this.libelleAR;
...
export class DelegationDtoPagedResultDto implements IDelegationDtoPagedResultDto {
    items: DelegationDto[] | undefined;
    totalCount: number;

    constructor(data?: IDelegationDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(DelegationDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): DelegationDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new DelegationDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): DelegationDtoPagedResultDto {
        const json = this.toJSON();
        let result = new DelegationDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IDelegationDtoPagedResultDto {
    items: DelegationDto[] | undefined;
    totalCount: number;
}
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["delegations"])) {
                ...
                for (let item of _data["delegations"])
                    this.delegations.push(Delegation.fromJS(item));
            }
        }
    }
